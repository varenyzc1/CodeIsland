...
final class L10n: ObservableObject {
    ...
    private static let en: [String: String] = [
        ...
        "feishu_intro_title": "Feishu Bots",
        "feishu_intro_body": "Configure one Feishu bot per AI tool. CodeIsland connects through Feishu WebSocket long connection, then you bind a chat by sending a generated key to the bot.",
        "feishu_command_hint": "Commands in Feishu after binding: `status`, `approve`, `deny`, `reply your answer`.",
        "feishu_event_hint": "Required event subscriptions: `im.message.receive_v1` and `card.action.trigger`.",
        "feishu_quick_create_bot": "Quick Create Feishu Bot",
        "feishu_tools": "AI Tools",
        "feishu_enabled": "Enable Feishu Bot",
        "feishu_disabled": "Disabled",
        "feishu_missing_credentials": "Missing App ID or App Secret",
        "feishu_send_test": "Send Test",
        "feishu_disconnected": "Not connected",
        "feishu_binding_key": "Binding Key",
        "feishu_bind_hint": "Copy this key and send it to the Feishu bot from the chat you want to bind.",
        "feishu_copy_key": "Copy Key",
        "feishu_regenerate_key": "Regenerate Key",
        "feishu_not_bound": "Not bound yet",
        "feishu_bound_to": "Bound chat: %@",
        "feishu_open_config_file": "Reveal Feishu config file",
        "save": "Save",
    ...
    private static let zh: [String: String] = [
        ...
        "remote_remove": "删除",
        "feishu_intro_title": "飞书机器人",
        "feishu_intro_body": "可以为每个 AI 工具单独配置一个飞书机器人。CodeIsland 会通过飞书 WebSocket 长连接接收消息，再通过绑定码自动绑定目标会话。",
        "feishu_command_hint": "绑定成功后，在飞书里可回复：`status`、`approve`、`deny`、`reply 你的答案`。",
        "feishu_event_hint": "需要在飞书后台订阅事件：`im.message.receive_v1` 和 `card.action.trigger`。",
        "feishu_quick_create_bot": "快速创建飞书机器人",
        "feishu_tools": "AI 工具",
        "feishu_enabled": "启用飞书机器人",
        "feishu_disabled": "未启用",
        "feishu_missing_credentials": "缺少 App ID 或 App Secret",
        "feishu_send_test": "发送测试消息",
        "feishu_disconnected": "未连接",
        "feishu_binding_key": "绑定码",
        "feishu_bind_hint": "复制这个绑定码，然后在你想绑定的飞书会话里发给机器人。",
        "feishu_copy_key": "复制绑定码",
        "feishu_regenerate_key": "重新生成绑定码",
        "feishu_not_bound": "尚未绑定",
        "feishu_bound_to": "已绑定会话：%@",
        "feishu_open_config_file": "在访达中显示飞书配置文件",
        "save": "保存",
